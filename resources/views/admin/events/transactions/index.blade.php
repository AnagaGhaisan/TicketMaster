<x-app-layout>
  ...
  <div id="confirmationModal" class="hidden fixed inset-0 z-50 overflow-auto bg-smoke-light">
    <div class="relative p-8 bg-white w-full max-w-md m-auto flex-col flex rounded-lg">
      ...
      <div class="mt-4">
        <button id="confirmButton" class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 transition duration-300 ease-in-out">
          Ya
        </button>
        <button id="cancelButton" class="px-4 py-2 bg-gray-300 rounded ml-2">
          Batal
        </button>
      </div>
    </div>
